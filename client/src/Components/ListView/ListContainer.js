...
function ListContainer({ sites, user, onNewVisit, onNewSite, onDeleteVisit }) {
  ...
  return (
    <div className="container">
      ...
      <div className="row">
        {filteredSites.map((site) => <ListCard key={site.id} site={site} onNewVisit={onNewVisit} onDeleteVisit={onDeleteVisit} user={user} />)}
